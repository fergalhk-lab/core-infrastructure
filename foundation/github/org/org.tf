locals {
  repos = {
    "core-infrastructure" = { private = false, description = "foundational infrastructure" }
    "apps"                = { private = false, description = "monorepo for apps" }
    "deployer"            = { private = false, description = "simple deployment tool" }
